...
At least, the [HIBP](https://haveibeenpwned.com/) password list should be used as a blocklist. You must adhere to the secure password storage guidelines as discussed in class.
